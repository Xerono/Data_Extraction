...
for Soils_Q in Soils_Q_List:
    for Layernums in Layernums_List:
        ...
        if Soils_Q:
            Model_path = CurDir + "/Models/SC_Model_Soils_bu/"
            Model_Name = Type + Layers + "_Soils_bu"
            PercentageO = 90
            ...
            Model_path = CurDir + "/Models/SC_Model_Coordinates_bu/"
            Model_Name = Type + Layers + "_Coords_bu"
            PercentageO = 70

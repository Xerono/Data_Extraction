...
if not os.path.exists(CurDir + "/Models/" + ModName + "/" + "Parameters.pickle"):
            ...
            if oDType == "Train":
                ...
                if oDType == "Test":
                    ...
                    if oDType == "All":
                        ...
                        print(oDType)
                        input()
    with open(CurDir + "/Files/TCF_Coords_Training.pickle", "wb") as file:
        pickle.dump(TrainingData, file)
    with open(CurDir + "/Files/TCF_Coords_Test.pickle", "wb") as file:
        pickle.dump(TestData, file)
    with open(CurDir + "/Files/TCF_Coords_All.pickle", "wb") as file:
    ...
    with open(CurDir + "/Files/TCF_Coords_Training.pickle", "rb") as file:
        TrainingData = pickle.load(file)
    with open(CurDir + "/Files/TCF_Coords_Test.pickle", "rb") as file:
        TestData = pickle.load(file)
    with open(CurDir + "/Files/TCF_Coords_All.pickle", "rb") as file:

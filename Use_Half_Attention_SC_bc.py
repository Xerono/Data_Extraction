...
for Soils_Q in Soils_Q_List:
    for Layernums in Layernums_List:
        ...
        if Soils_Q:
            Model_path = CurDir + "/Models/SC_Model_Soils_bc/"
            Model_Name = Type + Layers + "_Soils_bc"
            PercentageO = 90
            ...
            Model_path = CurDir + "/Models/SC_Model_Coordinates_bc/"
            Model_Name = Type + Layers + "_Coords_bc"
            PercentageO = 70

...
Soils_Q_List = [True, False]
Layernums_List = [[0], [5], [0, 1, 2, 3, 4, 5]]
...
for Soils_Q in Soils_Q_List:
    for Layernums in Layernums_List:
        print(Soils_Q)
        print(Layernums)
        ...
        if Soils_Q:
            Model_path = CurDir + "/Models/SC_Model_Soils_dc/"
            Model_Name = Type + Layers + "_Soils_dc"
            PercentageO = 90
            ...
            Model_path = CurDir + "/Models/SC_Model_Coordinates_dc/"
            Model_Name = Type + Layers + "_Coords_dc"
            PercentageO = 70
